...
function TTSView({ activePosition, cellOrientation, cellHeight, convertedEntries, firstValues, onChangeCell, onClickCell, onClickOutsideCell, onClickClue, totalCols, totalRows }) {
  return (
    <div className="tts-container">
      <div className="tts-questions">
        <div className="across">
          <h2>Mendatar</h2>
          {puzzleData
            .filter((data) => data.orientation === "across")
            .map((data) => (
              <p
                key={data.position}
                onClick={onClickClue}
        ...
        <div className="down">
          <h2>Menurun</h2>
          {puzzleData
            .filter((data) => data.orientation === "down")
            .map((data) => (
              <p
                key={data.position}
                onClick={onClickClue}
